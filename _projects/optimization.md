...
period: "상시"
summary: "모바일 타겟 성능과 라이브 빌드 안정성을 위해 UI 렌더링·틱·메모리(GC/풀링/수명)를 다층적으로 최적화. 전체 변경의 약 30%가 버그·크래시·현상 수정."
...
## 5. 라이브 품질 대응
미니맵 깜빡임, 채팅 RichText, 순례 보상 정산, 장비 중복 착용, 미장착 슬롯 등 **다수의 현상·크래시**를 분석·수정하고, **Jira 티켓 연계**로 회귀를 추적·핫픽스했습니다.
